...
public class ControlActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button mOnlyLeftButton = (Button) findViewById(R.id.button_only_left);
		mOnlyLeftButton.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				
				controller.onlyTurnLeft();
				
			}
		});
		
		Button mOnlyRightButton = (Button) findViewById(R.id.button_only_right);
		mOnlyRightButton.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
				
				controller.onlyTurnRight();
