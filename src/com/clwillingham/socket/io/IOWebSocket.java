...
public class IOWebSocket extends WebSocketClient {
	...
	public void init(String path) throws IOException, NotYetConnectedException, InterruptedException{
		send("1::"+path);
	}
	
	public void init(String path, String query) throws IOException, NotYetConnectedException, InterruptedException{
		this.send("1::"+path+"?"+query);
		
	}
	
	public void sendMessage(IOMessage message) throws IOException, NotYetConnectedException, InterruptedException{
		send(message.toString());
	}
	
	public void sendMessage(String message) throws IOException, NotYetConnectedException, InterruptedException{
